#ifndef CPP2_S21_CONTAINERS_SRC_INCLUDE_S21_SET_H_
#define CPP2_S21_CONTAINERS_SRC_INCLUDE_S21_SET_H_
...
class set : public red_black_tree<Key, Key> {
 public:
  ...
  set(std::initializer_list<Key> initList)
      : red_black_tree<Key, Key>(initList) {}
  ...
  std::pair<iterator, bool> insert(const Key& value) {
    std::pair<typename red_black_tree<Key, Key>::Node*, bool> return_insert =
        this->insert_local(value);
...
#endif  // CPP2_S21_CONTAINERS_SRC_INCLUDE_S21_SET_H_
