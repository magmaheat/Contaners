#ifndef CPP2_S21_CONTAINERS_SRC_INCLUDE_S21_MULTISET_H_
#define CPP2_S21_CONTAINERS_SRC_INCLUDE_S21_MULTISET_H_
...
class multiset : public red_black_tree<Key, Key> {
 public:
  ...
  multiset(multiset&& other) noexcept
      : red_black_tree<Key, Key>(std::move(other)) {}
  ~multiset() = default;
...
#endif  // CPP2_S21_CONTAINERS_SRC_INCLUDE_S21_MULTISET_H_